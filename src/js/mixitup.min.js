				...
				switch (a.type) {
					...
					case 'toggle':
						(l.filter = a.filter || i.getAttribute('data-toggle')),
							(r =
								'live' === a.status ? n.hasClass(i, a.classNames.active) : 'active' === a.status);
				}
		...
		n.extend(e.Mixer.prototype, {
			...
			getAttributeValue: function (t, n) {
				...
				return (
					...
					null === i &&
						...
						console.warn(
							e.messages.warningInconsistentSortingAttributes({ attribute: 'data-' + n })
						),
			...
			getFinalMixData: function (e) {
				...
				for (
					(a.config.animation.clampHeight || a.config.animation.clampWidth) &&
						...
						e.viewportDeltaY =
							e.docState.viewportHeight - this.dom.document.documentElement.clientHeight,
			...
			parseMultimixArgs: function (t) {
				var a = this,
					...
					r = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandMultimix(), r = 0;
					r < t.length;
					r++
				)
					(o = t[r]),
			...
			parseFilterArgs: function (t) {
				var a = this,
					...
					r = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandFilter(), r = 0;
					r < t.length;
					r++
				)
					(o = t[r]),
			...
			parseSortArgs: function (t) {
				var a = this,
					...
					s = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandSort(), s = 0;
					s < t.length;
					s++
				)
					if (((o = t[s]), null !== o))
			...
			parseInsertArgs: function (t) {
				var a = this,
					...
					r = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandInsert(), r = 0;
					r < t.length;
					r++
				)
					(o = t[r]),
			...
			parseRemoveArgs: function (t) {
				var a = this,
					...
					s = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandRemove(), s = 0;
					s < t.length;
					s++
				)
					if (((r = t[s]), null !== r))
			...
			parseDatasetArgs: function (t) {
				var a = this,
					...
					r = -1;
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandDataset(), r = 0;
					r < t.length;
					r++
				)
					if (((o = t[r]), null !== o))
			...
			diffDatasets: function (t) {
				...
				for (a.callActions('beforeDiffDatasets', arguments), m = 0; (s = t.newDataset[m]); m++) {
					if ('undefined' == typeof (d = s[a.config.data.uidKey]) || d.toString().length < 1)
						throw new TypeError(
							e.messages.errorDatasetInvalidUidKey({ uidKey: a.config.data.uidKey })
						);
			...
			init: function (t, n, a) {
				...
				if (
					...
					if ('undefined' == typeof (o = a[n.config.data.uidKey]) || o.toString().length < 1)
						throw new TypeError(
							e.messages.errorDatasetInvalidUidKey({ uidKey: n.config.data.uidKey })
						);
